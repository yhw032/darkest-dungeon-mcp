...
export const serverInstructions = [
  ...
  "Answer in the user's language, prefer localized display names, and preserve internal IDs as stable references.",
  "Use save-state tools for campaign facts instead of guessing. Live tools share a two-minute snapshot; call refresh_game_state when the user reports an in-game change.",
