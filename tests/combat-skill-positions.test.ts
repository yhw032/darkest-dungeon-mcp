  ...
  assert.deepEqual(parseHeroCombatSkillPositions(graveRobber, "grave_robber"), [
    {
      ...
      skillId: "lunge",
      usableFromPartyPositions: [3, 4],
      target: { side: "enemy", mode: "single", positions: [1, 2, 3] },
    ...
    },
    {
      ...
      target: { side: "enemy", mode: "group", positions: [2, 3] },
      movement: { backward: 0, forward: 0 },
    },
    {
      heroClass: "grave_robber",
      skillId: "shadow_fade",
      usableFromPartyPositions: [1, 2],
      target: { side: "self", mode: "single", positions: [] },
      movement: { backward: 2, forward: 0 },
    },
    {
      heroClass: "grave_robber",
      skillId: "dagger_guard",
      usableFromPartyPositions: [1, 2, 3, 4],
      target: { side: "ally", mode: "single", positions: [1, 2, 3, 4] },
      movement: { backward: 0, forward: 0 },
    },
    {
      heroClass: "grave_robber",
      skillId: "random_shot",
      usableFromPartyPositions: [4],
      target: { side: "enemy", mode: "random", positions: [1, 2, 3, 4] },
      movement: { backward: 0, forward: 0 },
    },
  ]);
});
