  ...
  treePriorities: [
    {
      ...
      priorityTier: "S",
      strategicImportance: "Upgrade weapon damage and stats.",
    },
    {
      buildingId: "stage_coach",
      treeId: "network",
      priorityTier: "S",
      strategicImportance: "Expand weekly recruit pool.",
    },
    {
      buildingId: "stage_coach",
      treeId: "roster_size",
      priorityTier: "A",
      strategicImportance: "Expand roster capacity.",
    },
    {
      buildingId: "tavern",
      treeId: "bar",
      priorityTier: "C",
      strategicImportance: "Expand tavern relief slots.",
    },
  ],
};
